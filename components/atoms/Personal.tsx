	...
	return (
		<div className="personal-wrapper">
			...
			<div className="author-link-content">
				<a href="https://github.com/Yuta07" target="_blank" rel="noreferrer" className="author-link">
					<amp-img src="/links/github.svg" fallback="" width="24" height="24" layout="intrinsic" alt="github"></amp-img>
				</a>
				<a href="mailto:mono.12dev@gmail.com" target="_blank" rel="noreferrer" className="author-link">
					<amp-img src="/links/mail.svg" fallback="" width="24" height="24" layout="intrinsic" alt="mail"></amp-img>
				</a>
				<a href="https://twitter.com/yutazon7" target="_blank" rel="noreferrer" className="author-link">
					<amp-img
